...
bigIntArray[2] = 10;
bigIntArray[3] = 10;
// ... don't do this. DON'T REPEAT YOURSELF in your code! Loop!
...
//ANSWER: bigIntArray[0] = 3, I'm alittle confuse here because i know bigIntArray[0] = 10 then - 7  should equal 3.

// If you can't figure it out, just println() out their .length field!

// Fill both of these last arrays with values here:

int[] otherArray = {10,-10,40,50,-20,60};
int[] lastArray = {200,500,100,-400,300};

//LOOP:
for (int i = 0; i < otherArray.length; i++) {
  println("this is " + i + " is: " + lastArray[3]);
}